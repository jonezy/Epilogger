    ...
    $.extend($.fn, {
        ...
        miniColors: function (o, data) {
            ...
            function create(input, o, data) {
                ...
                // Create trigger
                trigger = $('<a class="miniColors-trigger" id=' + input.attr('id') + 'js' + ' style="background-color: #' + color + '" href="#"></a>');
            ...
            function show(input) {
				...
				//	.append('<div class="miniColors-hextext"><input type="minicolors" class="hextext" id="hextext" name="hextext" maxlength="7" size="7" value="" autocomplete="on" ></input><input type="button" value="view" id="preview1"></div>')
                    .css('display', 'none')
                ...
                $(document)
					.on('mousedown.miniColors touchstart.miniColors', function (event) {
					    ...
					    //					    if (testSubject.hasClass('miniColors-hextext')) {
					    //					        return true;
					    //					    }
            ...
            function setColor(input, hsb, updateInput) {
                ...
                var hex = hsb2hex(hsb),
					...
					rgb = hsb2rgb(hsb);
                var hexColor = (prefix + convertCase(hex, input.data('letterCase')));
                if (input.attr('id') == 'color1') {
                    $('.colour1').css('color', hexColor);
                    $('#hideColor1').val(hexColor);
                }
                if (input.attr('id') == 'color2') {
                    $('.colour2,a').css('color', hexColor);
                    $('#hideColor2').val(hexColor);
                }
                if (input.attr('id') == 'color3') {
                    $('.colour3').css('color', hexColor);
                    $('#hideColor3').val(hexColor);
                }
                input.data('hsb', hsb);
